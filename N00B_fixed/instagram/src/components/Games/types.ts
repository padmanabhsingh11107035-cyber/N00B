...
export const ALL_50_MINI_GAMES: MiniGameMeta[] = [
  ...
  },
  {
    ...
    category: 'brain',
    description: 'High-stakes chess vs a genuinely strong bot: win for +50,000 NOOBs, but lose vs the bot and your entire balance resets to 0. Play a friend instead for no risk.',
