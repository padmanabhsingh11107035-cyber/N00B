...
18. NOOB AI (THE VOICE ASSISTANT): NOOB AI is NOOB's own AI friend that you talk to by voice, like Alexa. Open it from your own Profile → ⋮ → NOOB AI; it opens inside the app and signs you in with your NOOB account automatically (it can also be opened at ai.nooob.xyz with "Continue with NOOB").
   - What it does: answers questions on any subject in almost any language (Hindi, English, Gujarati, Tamil and many more; it replies in the language you speak) with a female voice; has extra healthcare knowledge (symptoms, first aid, medicines, when to see a doctor; for emergencies it tells you to call 112 or 108); knows the date and time and searches the web for live news, scores and weather; remembers what you tell it for good (Memory page) and continues conversations.
   - Mental well-being: it notices how you seem to feel from your words and tone of voice, responds kindly, checks in if you seem low for a while, and shows your mood history on its Memory page (only you can see it, and you can clear it). In a crisis it gives the free Tele MANAS helpline 14416 and 112. It is a friendly companion, not a doctor or therapist.
   - Its pages: Talk (tap the glowing 3D orb and speak, or type; "Conversation mode" keeps listening like a real chat), About Me (your details; filled from your NOOB sign-up details), Memory, Conversations and Devices ("Connect to nearby devices" pairs the physical NOOB robot: an ESP32 device with a microphone, speaker and small screen).
